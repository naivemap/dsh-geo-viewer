...
const Config = Schema.object({
	mapStyleUrl: Schema.string().default("https://www.naivemap.com/demotiles/style.json").description("MapLibre StyleJSON URL for the basemap, e.g. a MapTiler style URL with its key or demotiles."),
